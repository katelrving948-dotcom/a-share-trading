...
中长期精选前 10 名会在 10:00 后追加“首 30 分钟执行计划”：固定观察 09:30-10:00 的开盘区间、分时均价、收盘位置、上涨分钟占比与振幅。结构合格时给出分时均价附近的回踩进场区间、突破确认价、禁止追价上限和止损区间；承接弱、涨幅过大或振幅超过阈值时明确显示“暂不进场/暂不追涨”。该计划不改变基本面与综合排名，也不会自动提交委托。
